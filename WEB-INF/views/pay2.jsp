								...
								<td><span class="bdr"></span>
									<div class="product_info">
										...
										<div class="product_dsc">
											...
											<a href="https://shopping.naver.com/outlink/itemdetail/6918605682"
												target="_blank" class="product_name"> 
												<strong>상품명을 적어주세요.</strong>
											</a>
										</div>
										<span class="vm"></span>
									</div></td>
					...
					<div class="destination_wrap">
						<div class="deliver_wrap">
							...
							<ul class="addr_list _deliveryPlaces _deliveryPlaces_0">
								<li>배송지명&emsp;&emsp;&emsp;<input type="text" size=25></li>
								<br />
								<li>수령인&emsp;&emsp;&emsp;&emsp;<input type="text" size=25></li>
								<br />
								...
								</select> &nbsp;-&nbsp;<input type="text" size=10>&nbsp;-&nbsp;<input
									type="text" size=10></li>
								<br/>
								<li>배송지&emsp;&emsp;&emsp;&emsp;<input type="text" size="10"
									id="addra">&nbsp;
									<button type="button" class="addr_btn" id="addr_btn">우편번호</button></li>
								<br /> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;
								<input type="text" size="50" id="addrb">
								<br /><br />&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;
								<input type="text" size="50" id="addrc">
								
								<li>배송메모&emsp;&emsp;&emsp;<input type="text" size=45></li>
								<br/>
							</ul>
						</div>
						...
						<div class="payment">
							...
							<li class="paymethod _payMethodTab _naverPaymentsBankTab">
								<div class="header tooltip_area">
									...
									<label for="naverPaymentsBankRadio" class="tooltip_area">계좌
										이체</label> <em class="_generalPaymentAmount payment_price"></em>
								</div>
							</li>
							...
							<li class="paymethod _payMethodTab _naverPaymentsCardTab">
								<div class="header">
									<span class="ajax_radio radio-applied _payMethodRadio">
										...
										class="_click(nmp.front.order.order_sheet.changePaymentTab(naverPaymentsCard)) _stopDefault">
									</span> <label for="naverPaymentsCardRadio">카드 결제</label> <em
...
<!-- 										</span> <label for="purpose1">계좌 이체</label> -->
<!-- 									</div> -->
<!-- 								</li> -->
<!-- 								<li class="paymethod"> -->
<!-- 									<div class="header"> -->
...
<!-- 											<span class="radio-mark"></span> <input type="radio" -->
<!-- 											name="purpose" id="purpose1" disabled=""> -->
<!-- 										</span> <label for="purpose1">카드 결제</label> -->
<!-- 									</div> -->
<!-- 								</li> -->
<!-- 							</ul> -->
