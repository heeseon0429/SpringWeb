			...
			<div class="row" style="text-align: center;">
				...
				<div class="col-12 col-md-4 col-lg-4 mb-5 mb-md-0">
					<a class="product-item" href="cart.html"><img
						...
						<h3 class="product-title">요새로제</h3> <strong class="product-price">19,900</strong>
						 </a>
				</div>
				<!-- 주간순위 1위 끝 -->
				...
				<div class="col-12 col-md-4 col-lg-4 mb-5 mb-md-0">
					<a class="product-item" href="cart.html"> <img
						...
						class="img-fluid product-thumbnail">
						<h3 class="product-title">메들리손막걸리</h3> <strong class="product-price">10,000</strong>
				...
				<div class="col-12 col-md-4 col-lg-4 mb-5 mb-md-0">
					<a class="product-item" href="cart.html"> <img
						src="resources/images/킹키펌킨1.jpg" class="img-fluid product-thumbnail">
						<h3 class="product-title">킹키펌킨</h3> <strong class="product-price">6,900</strong>
